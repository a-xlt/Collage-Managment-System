<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Collage_Managment_System.Teacher.Add" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <h1 class="alert alert-secondary bg-secondary text-center text-light ">إضافة استاذ جديد
        </h1>
        <hr />
        ...
        <p>اسم الاستاذ</p>
        <asp:TextBox ID="teacherNameTXT" CssClass="form-control" runat="server"></asp:TextBox>

        <hr />

        <p>تاريح ميلاد الأستاذ</p>

        <asp:TextBox ID="TeacherbirthdayTXT" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>

        <hr />

        <p>القسم</p>

        <asp:DropDownList ID="debDDL" CssClass="form-select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="debDDL_SelectedIndexChanged"></asp:DropDownList>
        ...
        <asp:TextBox ID="phoneTXT" CssClass="form-control" TextMode="Phone" runat="server"></asp:TextBox>
        <hr />


        <p>المادة التي يدرسها الاستاذ</p>
                <asp:DropDownList ID="metrialddl" CssClass="form-select" runat="server"></asp:DropDownList>
        <hr />
