<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Collage_Managment_System.Department.Add" %>
...
<body>
 ...
 <div class="container-fluid">
       ...
       <div class="form-group">
           <label class="control-label" for="DepartmentNameTXT">اسم القسم </label>
           <input
               type="text"
               id="DepartmentNameTXT"
               class="form-control"
               runat="server" />
       </div>
       <br />
       <asp:Button ID="Button1" CssClass="btn btn-outline-success w-100" runat="server" Text="اضافة" OnClick="Button1_Click" />
