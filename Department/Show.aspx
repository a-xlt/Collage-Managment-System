<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Collage_Managment_System.Department.Show" %>
...
<body>
 ...
 <br />
    ...
    <form id="form1" runat="server">
          <h1 class="alert alert-secondary bg-secondary text-center text-light ">عرض معلومات قسم
  </h1>
  <hr />
        <div>
             <asp:DropDownList ID="departmentDDL" style="font-size:22px;" runat="server" CssClass="form-select text-center" AutoPostBack="true" OnTextChanged="searchBTN_Click"> </asp:DropDownList>
            <br />
            ...
            <br />
            <div class="row">
                <div class="col-12 text-center" style="font-size:22px;">عدد القاعات الدراسية
                    <asp:Label ID="Label4" CssClass="text-bg-dark bg-opacity-25 text-primary-emphasis" runat="server" Text=""></asp:Label>
