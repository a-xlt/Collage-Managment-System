<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Collage_Managment_System.Absence.Add" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            <p class="h2 text-decoration-underline text-center">
                اضافة حضور لمادة 
            </p>
            <hr />
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1"></asp:DropDownList>
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:con %>' SelectCommand="SELECT * FROM [Department]"></asp:SqlDataSource>
        </div>
    </form>
