<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Collage_Managment_System.Student.Edit" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <h1 class="alert alert-secondary bg-secondary text-center text-light ">تعديل بيانات طالب
            </h1>
        </div>
