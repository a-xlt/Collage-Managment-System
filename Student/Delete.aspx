<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Collage_Managment_System.Student.Delete" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <h1 class="alert alert-secondary bg-secondary text-center text-light ">حذف بيانات طالب
</h1>

            <div class="container">
                <div class="input-group mb-3">
                    <asp:TextBox ID="idSearch" CssClass="focus-ring focus-ring-danger w-50 form-control" placeholder="ID الطالب " runat="server"></asp:TextBox>
            ...
            <br />
            <br />
            <asp:Button ID="DeleteBTN" runat="server" CssClass="btn btn-outline-danger w-100" Text="حذف الطالب " OnClick="DeleteBTN_Click" />
            <br />
