<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="Collage_Managment_System.Classroom.Delete" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <h1 class="alert alert-secondary bg-secondary text-center text-light ">حذف قاعة دراسية
        </h1>
        <div class="container">
