<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Collage_Managment_System.Classroom.Show" %>
...
<br />
  ...
  <hr />
        <div>
            ...
            <div class="row">
                <div class="col-6 text-center fw-bold" style="font-size:26px;">رمز القاعة</div>
                <div class="col-6 text-center fw-bold" style="font-size:26px;">عدد الطلاب</div>
            </div>

             <div class="row">
                <div class="col-6 text-center " style="font-size:22px;">
                    <pre id="Label1" runat="server" ></pre>

                </div>
                <div class="col-6 text-center " style="font-size:22px;">
                    <pre id="Label2" runat="server" ></pre></div>
