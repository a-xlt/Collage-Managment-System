<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Collage_Managment_System.Classroom.Add" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <h1 class="alert alert-secondary bg-secondary text-center text-light ">إضافة قاعة دراسية جديدة
            </h1>
            <hr />
            ...
            <p>رمز القاعة</p>
            <asp:TextBox ID="ClassCodeTXT" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <p>عدد الطلاب</p>
            <asp:TextBox ID="NumberOfSTUTXT" CssClass="form-control" TextMode="Number"  runat="server"></asp:TextBox>
            <hr />
