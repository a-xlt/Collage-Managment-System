<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Collage_Managment_System.Material.Add" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <h1 class="alert alert-secondary bg-secondary text-center text-light ">إضافة مادة جديدة
        </h1>
        <hr />
